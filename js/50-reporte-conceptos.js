...
const CATALOGO_CONCEPTOS_HARDCODED = [
  ...
  { codigo: 2,     descripcion: 'Horas Extras 50%',                          columna: 'HABERES', categoria: 'Horas extras',          tipo: 'REM',          calculo: 'novedad',  formula: 'valorHora × 1.5 × cantidad', baseLegal: 'Art. 201 LCT' },
